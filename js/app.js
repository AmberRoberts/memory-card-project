...
function addMove() {
  ...
  moves.textContent = moveCount/2; // Displays amount of moves in score panel (.5 per card)
}
...
function modal() {
  ...
  document.querySelector(".moveTotal").textContent = moveCount/2;  // to match the move count
